...
class WeChatSpy:
    ...
    def query_contact_list(self, step=50, pid=None):
        ...
        :return:
        """
        data = {"code": 3, "key": "baofengxueonly", "step": step}
        self.__send(data, pid)

    def accept_new_contact(self, encryptusername, ticket, pid=None):
        data = {"code": 7, "key": "baofengxueonly", "encryptusername": encryptusername, "ticket": ticket}
        self.__send(data, pid)

    def query_chatroom_member(self, wxid, pid=None):
        data = {"code": 4, "wxid": wxid, "key": "baofengxueonly"}
        self.__send(data, pid)
